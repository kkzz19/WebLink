<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InterestSelection.aspx.cs"
    Inherits="InterestSelection" MasterPageFile="~/Site.master" %>
        ...
        <ItemTemplate>
            <tr>
                <td>
                    ...
                    NavigateUrl='<%#String.Format("~/InterestPages/InterestNews.aspx?InterestName={0}&InterestID={1}", Eval("Name"), Eval("InterestID")) %>'
