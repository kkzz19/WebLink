...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="Black"
        Text="Administrator Home Page"></asp:Label>
    <br />
    <asp:Label ID="welcomeLabel" runat="server" Font-Size="Medium" Font-Bold="True"></asp:Label>
    <br />
    <asp:Label ID="joinDateLabel" runat="server" Text="Label" Font-Italic="True" Font-Size="Small"></asp:Label>
    <br />
    <br />
    <a href="SelectCategory.aspx" style="color: #0000FF">Modify Interests (Click Here)</a><br />
    <br />
    ...
    <br />
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="Black"
